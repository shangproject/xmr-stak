...
constexpr size_t CRYPTONIGHT_SHANG_MEMORY = 4 * 1024 * 1024;
constexpr uint32_t CRYPTONIGHT_SHANG_MASK = 0x3FFFF0;
constexpr uint32_t CRYPTONIGHT_SHANG_ITER = 0x100000;
...
template<>
inline constexpr size_t cn_select_memory<cryptonight_shang>() { return CRYPTONIGHT_SHANG_MEMORY; }
...
inline size_t cn_select_memory(xmrstak_algo algo)
{
	...
	case cryptonight_shang:
		return CRYPTONIGHT_SHANG_MEMORY;		
	default:
		return 0;
	}
}
...
template<>
inline constexpr uint32_t cn_select_mask<cryptonight_shang>() { return CRYPTONIGHT_SHANG_MASK; }
...
template<>
inline constexpr uint32_t cn_select_iter<cryptonight_shang>() { return CRYPTONIGHT_SHANG_ITER; }
